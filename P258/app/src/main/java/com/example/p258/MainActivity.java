    ...
    public void clickbt(View view){
        ...
        switch (view.getId()){
            ...
            intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.naver.com"));
                break;
            case R.id.button2:
                intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:010-4776-4831"));
                break;
            case R.id.button3:
                intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:010-4776-4831"));
                break;
        }
